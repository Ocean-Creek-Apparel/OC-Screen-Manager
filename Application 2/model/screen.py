...
class Screen:
    ...
    Attributes:
        screen_id (int): the id as defined in the database
    ...
    """
    def __init__(self, screen_id: int, location_id: int, quantity: int,
                 design: str, customer: str, description: str, in_use: bool):
    ...
    def read_all(cls, conn: sqlite3.Connection) -> list["Screen"]:
        ...
        with(conn):
            ...
            for row in rows:
                ...
                screen = cls(screen_id, location_id, quantity, design, customer, description, in_use)
                screens.append(screen)
            return screens
        
    def delete_screen(self, conn: sqlite3.Connection) -> bool:
        """
    ...
    def add_screen(self, conn: sqlite3.Connection) -> bool:
        """
